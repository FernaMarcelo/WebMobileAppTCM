...
public class EliminarClienteConexion extends AsyncTask<String, Void, Void> {
    String resultado = "";
    @Override
    protected Void doInBackground(String... params)
    {
        try{
            ...
            String  METHOD_NAME = "eliminarCliente";
            String  SOAP_ACTION = "http://tempuri.org/eliminarCliente";
